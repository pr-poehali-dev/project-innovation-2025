  ...
  const courses = [
    {
      ...
      description: "Для тех, кто хочет заниматься творчеством и зарабатывать на нём — даже если вы не умеете рисовать. Научитесь проводить прибыльные МК с печатью на пряниках: от сценария и материалов до продаж.",
    },
    {
      icon: "🍪",
      title: "Печать на пряниках: от нуля до профи",
      description: "Полный курс для тех, кто хочет творчества, но не умеет рисовать. Учитесь зарабатывать на пряниках через печать и роспись: замес теста, выпечка, глазурь, упаковка и продажи.",
    },
    {
      icon: "🎀",
      title: "Кенди бар",
