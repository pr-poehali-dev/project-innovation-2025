export function Benefits() {
  const courses = [
    ...
    },
    {
      ...
      description: "Пошаговый курс по пряничному делу: от замеса теста до красивой упаковки и первых продаж. Освоите заливку глазурью, пищевую печать и технику сушки — всё, чтобы уверенно принимать заказы.",
    },
    {
      icon: "🎀",
      title: "Кенди бар",
