  ...
  const courses = [
    {
      ...
      description: "Освойте разные техники нанесения изображений и контуров на пряник — без художественных навыков. Научитесь выстраивать МК от A до Z: программа, материалы, работа с группой и стабильный доход.",
    },
    {
      icon: "🍪",
