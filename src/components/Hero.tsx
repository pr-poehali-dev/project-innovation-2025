        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full w-fit">
              ...
              <span className="text-sm font-medium">Профессиональное кондитерское обучение</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight text-balance">
              Стань мастером пряников и кондитерского искусства
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Курсы для начинающих и опытных кондитеров: от росписи пряников до проведения мастер-классов
              и создания потрясающих кенди баров.
            </p>
            ...
            <div className="flex gap-8 pt-4 text-sm">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Авторских курса</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-96 md:h-full min-h-96">
            ...
            <img
              src="https://cdn.poehali.dev/projects/3205edb8-5a8f-47ea-ba27-1b3ef424dbeb/files/c533bd21-cb93-4ff8-947d-d85f10e63610.jpg"
              alt="Мастер-класс по пряникам"
